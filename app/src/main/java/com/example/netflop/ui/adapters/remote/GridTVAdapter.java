...
public class GridTVAdapter extends RecyclerView.Adapter<GridTVAdapter.ViewHolder> {
    ...
    public GridTVAdapter(List<AiringTodayModel> listTV, Context context, ItemTVOnClickListener itemTVOnClickListener,FavouriteMediaViewModel favouriteMediaViewModel) {
        this.listTV = listTV;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(optionalFavouriteMedia.isPresent()){
            holder.addGridTVButton.setImageResource(R.drawable.remove);
        }else {
            holder.addGridTVButton.setImageResource(R.drawable.add);
        }
        holder.addGridTVButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(optionalFavouriteMedia.isPresent()){
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            addGridTVButton=(ImageButton) itemView.findViewById(R.id.addGridTVButton);
        }
    }
}
