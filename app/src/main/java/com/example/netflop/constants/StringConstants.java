...
public class StringConstants {
    public static final String movieDetailPageDataKey="movieDetail";
    ...
    // filter
    public static final String isAdultKey="isAdult";
    public static final String isCheckAllKey="isCheckAll";
