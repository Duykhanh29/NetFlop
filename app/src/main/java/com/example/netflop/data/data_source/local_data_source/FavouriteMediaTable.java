...
public class FavouriteMediaTable {
        ...
        public static final String COLUMN_WATCH_STATUS="watchStatus";
        public static final String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME +" ("+COLUMN_ID +"  INTEGER PRIMARY KEY AUTOINCREMENT, "+COLUMN_MEDIA_ID+" INTEGER, "+COLUMN_TITLE+" TEXT, "+COLUMN_IMAGE+" TEXT, "+COLUMN_MEDIA_TYPE+" TEXT, "+COLUMN_SEASON+" INTEGER, "+COLUMN_WATCH_STATUS+" TEXT, "+COLUMN_EPISODE+" INTEGER )";
