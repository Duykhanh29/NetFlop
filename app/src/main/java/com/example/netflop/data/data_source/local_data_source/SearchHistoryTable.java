...
public class SearchHistoryTable {
    ...
    public static final String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME +" ("+COLUMN_ID +"  INTEGER PRIMARY KEY AUTOINCREMENT, "+COLUMN_SEARCH_KEY+" TEXT, "+COLUMN_SEARCH_TYPE+" TEXT, "+COLUMN_IS_ADULT+" INTEGER )";
}
